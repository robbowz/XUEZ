...
mkdir /root/xuez4/
mkdir /root/.xuez4/
cp /root/xuezd /root/xuez4/xuezd
cp /root/xuez-cli /root/xuez4/xuez-cli
cp /root/xuez-tx /root/xuez4/xuez-tx
cd xuez
sudo chmod +x /root/xuez4/xuezd
sudo chmod +x /root/xuez4/xuez-cli
...
sleep 1
cd ~/
/root/xuez4/xuezd -daemon -datadir=/root/.xuez4
sleep 20
echo "if server start failure try /root/xuez4/xuezd -reindex"
echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
echo "!                                                 !"
echo "!        Your third MasterNode Is setup		     !"
echo "!   					                             !"
